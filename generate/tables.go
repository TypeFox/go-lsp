...
var goplsType = map[string]string{
	...
	"Or_Result_textDocument_declaration":               "[]DefinitionLink",
	"Or_Result_textDocument_definition":                "[]DefinitionLink",
	"Or_Result_textDocument_documentSymbol":            "[]any",
	"Or_Result_textDocument_implementation":            "[]DefinitionLink",
	"Or_Result_textDocument_semanticTokens_full_delta": "any",
	"Or_Result_textDocument_typeDefinition":            "[]DefinitionLink",
